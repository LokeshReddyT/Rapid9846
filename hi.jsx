...
const Scene2_MeetSaraAndHerRepairShop = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.set(notingBadge, { x: 1200, y: 460, scale: 0.8 });
      ...
      master
        ...
        .to(
          stickyRef,
          { x: 1410, y: 475, scale: 0.1, duration: 1.5, ease: "power3.inOut" },
          "shelf_time+=0.8",
        )
        .to({}, { duration: 2 }) // Hold before fade
        .addLabel("exit")
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Separated Wrappers to prevent shaking! Position Outer, Float Inner */}
        <div
          ref={(el) => (refs.current.shopWrapper = el)}
          style={{
            position: "absolute",
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      master
        ...
        .to(movingDevice, { opacity: 0, duration: 0.3 }, "notify+=1.2")
        .set(movingDevice, { x: 540, y: 750, scale: 0.8 })
        .to(movingDevice, { opacity: 1, duration: 0.5 }, "notify+=1.5")
...
const Scene6_TheTransformationAndConclusion = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.set(p1Line, { strokeDasharray: 250, strokeDashoffset: 250 });
      ...
      gsap.set(p2FlyLog, { x: 420, y: 460, scale: 0.5 });
      gsap.set(p2FlyWork, { x: 1100, y: 460, scale: 0.5 });
      gsap.set(p2FlyUpdate, { x: 1500, y: 540, scale: 0.5 });
      gsap.set(p2FlyLive, { x: 820, y: 540, scale: 0.5 });
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <line
              ref={(el) => (refs.current.p2LineLog = el)}
              x1="420"
              y1="460"
              x2="820"
              y2="460"
            ...
            />
            <line
              ref={(el) => (refs.current.p2LineLive = el)}
              x1="820"
              y1="540"
              x2="420"
              y2="540"
              ...
              fill="none"
              opacity="0"
              markerEnd="url(#arrowGreenL)"
            />
            <line
              ref={(el) => (refs.current.p2LineWork = el)}
              x1="1100"
              y1="460"
              x2="1500"
              y2="460"
              ...
              fill="none"
              opacity="0"
              markerEnd="url(#arrowIndigoR)"
            />
            <line
              ref={(el) => (refs.current.p2LineUpdate = el)}
              x1="1500"
              y1="540"
              x2="1100"
              y2="540"
                ...
                <div style={{ marginTop: "auto" }}>
                  <div style={{ position: "relative", height: 40 }}>
                    ...
                    >
                      ...
                      />
                      <div
                        style={{ fontSize: 14, color: DS.colors.textSecondary }}
                      >
                        In Progress
                      </div>
                    </div>
